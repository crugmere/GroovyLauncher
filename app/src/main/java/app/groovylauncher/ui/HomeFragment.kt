...
import app.groovylauncher.MainViewModel
import app.groovylauncher.R
import app.groovylauncher.data.AppModel
import app.groovylauncher.data.Constants
import app.groovylauncher.data.Prefs
import app.groovylauncher.databinding.FragmentHomeBinding
import app.groovylauncher.helper.appUsagePermissionGranted
import app.groovylauncher.helper.dpToPx
import app.groovylauncher.helper.expandNotificationDrawer
import app.groovylauncher.helper.getChangedAppTheme
import app.groovylauncher.helper.getUserHandleFromString
import app.groovylauncher.helper.isPackageInstalled
import app.groovylauncher.helper.openAlarmApp
import app.groovylauncher.helper.openCalendar
import app.groovylauncher.helper.openCameraApp
import app.groovylauncher.helper.openDialerApp
import app.groovylauncher.helper.openSearch
import app.groovylauncher.helper.setPlainWallpaperByTheme
import app.groovylauncher.helper.showToast
import app.groovylauncher.listener.OnSwipeTouchListener
import app.groovylauncher.listener.ViewSwipeTouchListener
